...
library LibERC721Artefact {
    struct ERC721ArtefactDiamondStorage {
        bool initialized;
        // Token name
        string _name;
        // Token symbol
    ...
    function diamondStorage() internal pure returns (ERC721ArtefactDiamondStorage storage ds) {
        // Specifies a random position from a hash of a string
        bytes32 storagePosition = keccak256("diamond.standard.erc721Artefact.storage");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ERC721ArtefactDiamondStorage storage ds = diamondStorage();
